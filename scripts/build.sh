...
app="$build_root/Clash Bridge.app"

rm -rf "$app"
mkdir -p "$build_root"
mkdir -p "$app/Contents/MacOS" "$app/Contents/Resources"
/bin/cp -X "$src/Info.plist" "$app/Contents/Info.plist"
/bin/cp -X "$src/launcher.sh" "$app/Contents/MacOS/Clash Bridge"
/bin/cp -X "$src/ClashBridge.icns" "$app/Contents/Resources/ClashBridge.icns"
chmod 755 "$app/Contents/MacOS/Clash Bridge"
...
/bin/zsh -n "$app/Contents/MacOS/Clash Bridge"
